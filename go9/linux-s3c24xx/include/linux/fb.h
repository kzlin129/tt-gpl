...
#define FB_SCREENSAVE_STOP	0
#define FB_SCREENSAVE_START	1
...
struct fb_ops {
	...
	/* TFT-level screensave mode */
	int (*fb_screensave)(int mode, struct fb_info *info);
