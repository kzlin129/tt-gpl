...
#define S3C2450_GPBSLPCON	S3C2410_GPIOREG(0x1c)
#define S3C2450_GPESLPCON	S3C2410_GPIOREG(0x4c)
#define S3C2450_GPFUDP		S3C2410_GPIOREG(0x58)
#define S3C2450_GPJSLPCON	S3C2410_GPIOREG(0xdc)

#define S3C2410_GPA23		S3C2410_GPIONO(S3C2410_GPIO_BANKA, 23)
#define S3C2410_GPA23_OUTP	(0x0 << 23)
#define S3C2410_GPA23_RSMCLK	(0x1 << 23)

#define S3C2410_GPA24		S3C2410_GPIONO(S3C2410_GPIO_BANKA, 24)
#define S3C2410_GPA24_OUTP	(0x0 << 24)
#define S3C2410_GPA24_RSMAVD	(0x1 << 24)

#define S3C2410_GPA25		S3C2410_GPIONO(S3C2410_GPIO_BANKA, 25)
#define S3C2410_GPA25_OUTP	(0x0 << 25)
#define S3C2410_GPA25_DQM2	(0x1 << 25)

#define S3C2410_GPA26		S3C2410_GPIONO(S3C2410_GPIO_BANKA, 26)
#define S3C2410_GPA26_OUTP	(0x0 << 26)
#define S3C2410_GPA26_DQM3	(0x1 << 26)

#define S3C2410_GPA27		S3C2410_GPIONO(S3C2410_GPIO_BANKA, 27)
#define S3C2410_GPA27_OUTP	(0x0 << 27)
#define S3C2410_GPA27_nWE_CF	(0x1 << 28)

#define S3C2450_GPKCON		S3C2410_GPIOREG(0xe0)
#define S3C2450_GPKDAT		S3C2410_GPIOREG(0xe4)
#define S3C2450_GPKUDP		S3C2410_GPIOREG(0xe8)

#define S3C2410_GPK0		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 0)
#define S3C2410_GPK0_INP	(0x0 << 0)
#define S3C2410_GPK0_OUTP	(0x1 << 0)
#define S3C2410_GPK0_SDATA16	(0x2 << 0)

#define S3C2410_GPK1		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 1)
#define S3C2410_GPK1_INP	(0x0 << 2)
#define S3C2410_GPK1_OUTP	(0x1 << 2)
#define S3C2410_GPK1_SDATA17	(0x2 << 2)

#define S3C2410_GPK2		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 2)
#define S3C2410_GPK2_INP	(0x0 << 4)
#define S3C2410_GPK2_OUTP	(0x1 << 4)
#define S3C2410_GPK2_SDATA18	(0x2 << 4)

#define S3C2410_GPK3		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 3)
#define S3C2410_GPK3_INP	(0x0 << 6)
#define S3C2410_GPK3_OUTP	(0x1 << 6)
#define S3C2410_GPK3_SDATA19	(0x2 << 6)

#define S3C2410_GPK4		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 4)
#define S3C2410_GPK4_INP	(0x0 << 8)
#define S3C2410_GPK4_OUTP	(0x1 << 8)
#define S3C2410_GPK4_SDATA20	(0x2 << 8)

#define S3C2410_GPK5		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 5)
#define S3C2410_GPK5_INP	(0x0 << 10)
#define S3C2410_GPK5_OUTP	(0x1 << 10)
#define S3C2410_GPK5_SDATA21	(0x2 << 10)

#define S3C2410_GPK6		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 6)
#define S3C2410_GPK6_INP	(0x0 << 12)
#define S3C2410_GPK6_OUTP	(0x1 << 12)
#define S3C2410_GPK6_SDATA22	(0x2 << 12)

#define S3C2410_GPK7		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 7)
#define S3C2410_GPK7_INP	(0x0 << 14)
#define S3C2410_GPK7_OUTP	(0x1 << 14)
#define S3C2410_GPK7_SDATA23	(0x2 << 14)

#define S3C2410_GPK8		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 8)
#define S3C2410_GPK8_INP	(0x0 << 16)
#define S3C2410_GPK8_OUTP	(0x1 << 16)
#define S3C2410_GPK8_SDATA24	(0x2 << 16)

#define S3C2410_GPK9		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 9)
#define S3C2410_GPK9_INP	(0x0 << 18)
#define S3C2410_GPK9_OUTP	(0x1 << 18)
#define S3C2410_GPK9_SDATA25	(0x2 << 18)

#define S3C2410_GPK10		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 10)
#define S3C2410_GPK10_INP	(0x0 << 20)
#define S3C2410_GPK10_OUTP	(0x1 << 20)
#define S3C2410_GPK10_SDATA26	(0x2 << 20)

#define S3C2410_GPK11		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 11)
#define S3C2410_GPK11_INP	(0x0 << 22)
#define S3C2410_GPK11_OUTP	(0x1 << 22)
#define S3C2410_GPK11_SDATA27	(0x2 << 22)

#define S3C2410_GPK12		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 12)
#define S3C2410_GPK12_INP	(0x0 << 24)
#define S3C2410_GPK12_OUTP	(0x1 << 24)
#define S3C2410_GPK12_SDATA28	(0x2 << 24)

#define S3C2410_GPK13		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 13)
#define S3C2410_GPK13_INP	(0x0 << 26)
#define S3C2410_GPK13_OUTP	(0x1 << 26)
#define S3C2410_GPK13_SDATA29	(0x2 << 26)

#define S3C2410_GPK14		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 14)
#define S3C2410_GPK14_INP	(0x0 << 28)
#define S3C2410_GPK14_OUTP	(0x1 << 28)
#define S3C2410_GPK14_SDATA30	(0x2 << 28)

#define S3C2410_GPK15		S3C2410_GPIONO(S3C2410_GPIO_BANKK, 15)
#define S3C2410_GPK15_INP	(0x0 << 30)
#define S3C2410_GPK15_OUTP	(0x1 << 30)
#define S3C2410_GPK15_SDATA31	(0x2 << 30)

#define S3C2450_GPLSLPCON	S3C2410_GPIOREG(0xfc)
...
/* USBPAD in the documentation switches usb port 1 between host and device mode */
...
#ifdef CONFIG_CPU_S3C2443
#define S3C2443_EXTINT0	   S3C2410_GPIOREG(0x88)
#define S3C2443_EXTINT1	   S3C2410_GPIOREG(0x8C)
#define S3C2443_EXTINT2	   S3C2410_GPIOREG(0x90)
#endif
