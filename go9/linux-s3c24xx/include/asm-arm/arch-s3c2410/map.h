...
/* HS-MMC0 */
#define S3C2443_VA_HSMMC0  S3C2410_ADDR(0x01400000)
#define S3C2443_PA_HSMMC0  (0x4AC00000)
#define S3C2443_SZ_HSMMC0  SZ_1M

/* HS-MMC1 */
#define S3C2443_VA_HSMMC1  S3C2410_ADDR(0x01500000)
#define S3C2443_PA_HSMMC1  (0x4A800000)
#define S3C2443_SZ_HSMMC1  SZ_1M

/* HS-UDC */
#define S3C_VA_HSUDC	   S3C2410_ADDR(0x01600000)
#define S3C_PA_HSUDC       (0x49800000)
#define S3C_SZ_HSUDC       SZ_1M

/* SOCSRAM, steppingstone memory, 4KB, map 1M */
#define S3C_VA_SOCSRAM	   S3C2410_ADDR(0x01700000)
#define S3C_PA_SOCSRAM	   (0x40000000)
#define S3C_SZ_SOCSRAM	   SZ_1M

/* S3C2443 bus matrix controller */
#define S3C24XX_VA_MATRIX   S3C2410_ADDR(0x01800000)
#define S3C24XX_PA_MATRIX   (0x4E800000)
#define S3C24XX_SZ_MATRIX   SZ_1M

/* TFT LCD controller */
#define S3C2443_VA_TFTLCD  S3C2410_ADDR(0x01900000)
#define S3C2443_PA_TFTLCD  (0x4C800000)
#define S3C2443_SZ_TFTLCD  SZ_1M

/* ISA style IO, for each machine to sort out mappings for, if it
 * implements it. We reserve two 16M regions for ISA.
 */

#define S3C24XX_VA_ISA_WORD  S3C2410_ADDR(0x03000000)
#define S3C24XX_VA_ISA_BYTE  S3C2410_ADDR(0x04000000)
