...
/* conveniently all mapped to the same location... */
...
#define S3C2412_BANKCON1	S3C2412_MEMREG(0x0004)
#define S3C2412_BANKCON1_INIT_MASK	(0x3 << 0)
#define S3C2412_BANKCON1_INIT_NORM	(0x0 << 0)
#define S3C2412_BANKCON1_INIT_PALL	(0x1 << 0)
#define S3C2412_BANKCON1_INIT_MRS	(0x2 << 0)
#define S3C2412_BANKCON1_INIT_EMRS	(0x3 << 0)
#define S3C2412_BANKCON1_PWRDN		(1 << 4)
#define S3C2412_BANKCON1_AP		(1 << 5)
#define S3C2412_BANKCON1_WBUF		(1 << 6)
#define S3C2412_BANKCON1_BUSY		(1 << 31)

#define S3C2412_BANKCON2	S3C2412_MEMREG(0x0008)
#define S3C2412_BANKCON2_tRP_MASK	(0x3 << 0)
#define S3C2412_BANKCON2_tRCD_MASK	(0x3 << 2)
#define S3C2412_BANKCON2_CASLAT_MASK	(0x3 << 4)
#define S3C2412_BANKCON2_tRC_MASK	(0xf << 16)
#define S3C2412_BANKCON2_tRAS_MASK	(0xf << 20)

#define S3C2412_BANKCON3	S3C2412_MEMREG(0x000C)
#define S3C2412_BANKCON3_BURSTLEN_MASK	(0x7 << 0)
#define S3C2412_BANKCON3_BURSTTYPE	(1 << 3)
#define S3C2412_BANKCON3_CASLAT_MASK	(0x7 << 4)
#define S3C2412_BANKCON3_BA_MASK	(0x3 << 14)
#define S3C2412_BANKCON3_PASR_MASK	(0x7 << 16)
#define S3C2412_BANKCON3_DSEMRS_MASK	(0x3 << 21)
#define S3C2412_BANKCON3_BAEMRS_MASK	(0x3 << 30)

#define S3C2412_REFRESH		S3C2412_MEMREG(0x0010)

#define S3C2412_REFRESH		S3C2412_MEMREG(0x0010)
#define S3C2412_REFRESH_REFCYC_MASK	(0xffff << 0)

#define S3C2412_TIMEOUT		S3C2412_MEMREG(0x0014)
#define S3C2412_TIMEOUT_TIMEOUT_MASK	(0xffff << 0)
...
#define S3C2443_BANKCFG_BW		(1<<0)
#define S3C2443_BANKCFG_MEMCFG_MASK	(0x3 << 2)
#define S3C2443_BANKCFG_MEMCFG_SDR	(0x0 << 2)
#define S3C2443_BANKCFG_MEMCFG_MSDR	(0x1 << 2)
#define S3C2443_BANKCFG_ADDRCFG1_MASK	(0x3 << 4)
#define S3C2443_BANKCFG_ADDRCFG0_MASK	(0x3 << 6)
#define S3C2443_BANKCFG_CASBW1_MASK	(0x3 << 8)
#define S3C2443_BANKCFG_CASBW0_MASK	(0x3 << 11)
#define S3C2443_BANKCFG_RASBW1_MASK	(0x3 << 14)
#define S3C2443_BANKCFG_RASBW0_MASK	(0x3 << 17)

#define S3C2443_BANKCON1	S3C2443_MEMREG(0x0004)
#define S3C2443_BANKCON1_INIT_MASK	(0x3 << 0)
#define S3C2443_BANKCON1_INIT_NORM	(0x0 << 0)
#define S3C2443_BANKCON1_INIT_PALL	(0x1 << 0)
#define S3C2443_BANKCON1_INIT_MRS	(0x2 << 0)
#define S3C2443_BANKCON1_INIT_EMRS	(0x3 << 0)
#define S3C2443_BANKCON1_PWRDN		(1 << 4)
#define S3C2443_BANKCON1_AP		(1 << 5)
#define S3C2443_BANKCON1_WBUF		(1 << 6)
#define S3C2443_BANKCON1_BURSTSTOP	(1 << 7)
#define S3C2443_BANKCON1_RES8_MASK	(0x1ffff << 8)
#define S3C2443_BANKCON1_RES8_VALUE	(0x00001 << 8)
#define S3C2443_BANKCON1_RES26_MASK	(0x3 << 26)
#define S3C2443_BANKCON1_RES26_VALUE	(0x1 << 26)
#define S3C2443_BANKCON1_DQSINDLL_MASK	(0x7 << 28)
#define S3C2443_BANKCON1_DQSINDLL_VALUE (0x4 << 28)
#define S3C2443_BANKCON1_BUSY		(1 << 31)

#define S3C2443_BANKCON2	S3C2443_MEMREG(0x0008)
#define S3C2443_BANKCON2_tRP_MASK	(0x3 << 0)
#define S3C2443_BANKCON2_tRCD_MASK	(0x3 << 2)
#define S3C2443_BANKCON2_CASLAT_MASK	(0x3 << 4)
#define S3C2443_BANKCON2_tRC_MASK	(0xf << 16)
#define S3C2443_BANKCON2_tRAS_MASK	(0xf << 20)

#define S3C2443_BANKCON3	S3C2443_MEMREG(0x000C)
#define S3C2443_BANKCON3_BURSTLEN_MASK	(0x7 << 0)
#define S3C2443_BANKCON3_BURSTTYPE	(1 << 3)
#define S3C2443_BANKCON3_CASLAT_MASK	(0x7 << 4)
#define S3C2443_BANKCON3_RES7_MASK	(0xff << 7)
#define S3C2443_BANKCON3_RES7_VALUE	(0x00 << 7)
#define S3C2443_BANKCON3_BA_MASK	(0x3 << 14)
#define S3C2443_BANKCON3_PASR_MASK	(0x7 << 16)
#define S3C2443_BANKCON3_RES19_MASK	(0x3 << 19)
#define S3C2443_BANKCON3_RES19_VALUE	(0x0 << 19)
#define S3C2443_BANKCON3_DSEMRS_MASK	(0x3 << 21)
#define S3C2443_BANKCON3_RES23_MASK	(0x3 << 23)
#define S3C2443_BANKCON3_RES23_VALUE	(0x0 << 23)
#define S3C2443_BANKCON3_BAEMRS_MASK	(0x3 << 30)

#define S3C2443_REFRESH		S3C2443_MEMREG(0x0010)
#define S3C2443_REFRESH_REFCYC_MASK	(0xffff << 0)

#define S3C2443_TIMEOUT		S3C2443_MEMREG(0x0014)
#define S3C2443_TIMEOUT_TIMEOUT_MASK	(0xffff << 0)
