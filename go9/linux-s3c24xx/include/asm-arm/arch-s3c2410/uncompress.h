...
arch_decomp_setup(void)
{
	 ...
	 * after calling linux.
	 */
#if defined CONFIG_MACH_TOMTOMGO && !(defined CONFIG_SMDK2413_BOARD || defined CONFIG_SMDK2440_BOARD)
	tomtomgo_init();
#endif /* CONFIG_MACH_TOMTOMGO && !(CONFIG_SMDK2413_BOARD || CONFIG_SMDK2440_BOARD */
