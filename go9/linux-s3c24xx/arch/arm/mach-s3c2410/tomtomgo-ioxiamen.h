#define SUPPORT_XIAMEN

static backlight_mapping_t xiamen_bl_mapping = {17,22,26,31,34,36,38,40,42,45,47,
...
inline void IO_InitXiamen(void)
{
	VALUE_SET(id                 , GOTYPE_XIAMEN);
	...
	VALUE_SET(chargerresistor    , 3740);
	...
	VALUE_SET(backlight_mapping  , &xiamen_bl_mapping);
#ifdef __KERNEL__
...
inline void IO_InitXiamenUS(void)
{
