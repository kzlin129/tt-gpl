#define SUPPORT_CASABLANCA_GL
//#define SUPPORT_CASABLANCA_PR0
inline void IO_InitCasablancaGl(void)
{
	...
	STRING_SET(projectname,"Casablanca C");
...
/* Casablanca Y2 and Y4 (GL) */
inline void IO_InitCasablancaGlY2Y4( void )
{
}
