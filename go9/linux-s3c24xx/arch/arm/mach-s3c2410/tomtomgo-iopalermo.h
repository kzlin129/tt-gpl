#define SUPPORT_PALERMO


static backlight_mapping_t PalermoMapTable = {17,22,26,31,34,36,38,40,42,45,47,
	                49,52,54,57,59,62,64,67,70,72};



inline void IO_InitPalermo(void)
{
	VALUE_SET(id                 , GOTYPE_PALERMO);
	VALUE_SET(caseid             , GOCASE_PALERMO);
	...
	VALUE_SET(backlighttype	     , GOBACKLIGHT_CH0_EUP2584_350);
	...
	STRING_SET(usbname,"ONE (v8)");
	STRING_SET(familyname,"TomTom ONE");
	STRING_SET(projectname,"Palermo");
	STRING_SET(requiredbootloader,"5.4204");
