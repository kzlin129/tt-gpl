#define SUPPORT_EDINBURGH
inline void IO_InitEdinburgh(void)
{
	VALUE_SET(id                 , GOTYPE_EDINBURGH);
	...
	STRING_SET(usbname,"ONE (v3)");
	STRING_SET(familyname,"TomTom ONE");
	STRING_SET(projectname,"EDINBURGH");
	STRING_SET(requiredbootloader,"4.24");
