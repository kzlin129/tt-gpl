...
struct platform_device *s3c24xx_uart_devs[S3C24XX_MAX_UART_DEVS];
int s3c24xx_uart_count;
...
#endif /* defined(CONFIG_USB_GADGET) */
...
struct s3c2410_platform_i2c s3c_i2c_settings = {
        .flags          = 0,
        .slave_addr     = 0x08,
        .bus_freq       = 100*1000,
        .max_freq       = 130*1000, /* hack for cagliari/treviso dock */
...
struct platform_device s3c_device_i2c = {
	...
	.dev		  = { .platform_data = &s3c_i2c_settings }
};
...
static struct resource s3c_camif_resource[] = {
	[0] = {
		...
		.end   = S3C2440_PA_CAMIF + S3C24XX_SZ_CAMIF - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_CAM,
	...
	[S3C241X_CAMIF_BOOTMEM_IDX] =
	{
		.start = 0,					/* Start with NULL. Memory will be allocated later. */
		.end   = S3C241X_CAMIF_BOOTMEM_SIZE,		/* Start with length. Will be added to allocated memory later. */
...
struct platform_device s3c_device_i2c_camif =
{
	.name		  = "s3c2440-i2c-camif",
	.id		  = -1,
	.num_resources    = 0,
	.resource	  = NULL,
};
...
EXPORT_SYMBOL(s3c_device_i2c_camif);
#endif /* CONFIG_VIDEO_S3C241X_CAMIF */
#endif /* CONFIG_CPU_S32412 */

#if defined(CONFIG_CPU_S3C2443) || defined(CONFIG_CPU_S3C2450)
static struct resource s3c_tft_lcd_resource[] = {
        [0] = {
                .start = S3C2443_PA_TFTLCD,
                .end   = S3C2443_PA_TFTLCD + S3C2443_SZ_TFTLCD - 1,
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_LCD,
...
struct platform_device s3c_device_tft_lcd = {
        ...
        .id               = -1,
        .num_resources    = ARRAY_SIZE(s3c_tft_lcd_resource),
        .resource         = s3c_tft_lcd_resource,
        .dev              = {
                .dma_mask               = &s3c_device_lcd_dmamask,
                .coherent_dma_mask      = 0xffffffffUL
        }
};
EXPORT_SYMBOL(s3c_device_tft_lcd);

static struct resource s3c_hsmmc0_resource[] = {
        [0] = {
                .start = (__u32)S3C2443_VA_HSMMC0,
                .end   = (__u32)(S3C2443_VA_HSMMC0 + S3C2443_SZ_HSMMC0 - 1),
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_SDI_0,
...
static struct resource s3c_hsmmc1_resource[] = {
        [0] = {
                .start = (__u32)S3C2443_VA_HSMMC1,
                .end   = (__u32)(S3C2443_VA_HSMMC1 + S3C2443_SZ_HSMMC1 - 1),
                .flags = IORESOURCE_MEM,
        },
        [1] = {
                .start = IRQ_SDI_1,
...
static struct resource s3c_hsudc_resource[] = {
	[0] = {
		...
		.end   = S3C2443_PA_USBDEV + S3C24XX_SZ_USBDEV - 1,
		.flags = IORESOURCE_MEM,
	},
	[1] = {
		.start = IRQ_USBD,
...
struct platform_device s3c_device_hsudc = {
	.name		  = "s3c-hsudc",
	.id		  = -1,
	.num_resources	  = ARRAY_SIZE(s3c_hsudc_resource),
	.resource	  = s3c_hsudc_resource,
};
EXPORT_SYMBOL(s3c_device_hsudc);
#endif /* defined(CONFIG_USB_GADGET) */
#endif /* CONFIG_CPU_S3C2443 || CONFIG_CPU_S3C2450*/

#if 1 /* TODO: define infrastructure for SRAM */
/* SOC SRAM */
static struct resource s3c_socsram_resource[] = {
	[0] = {
		.start = S3C_PA_SOCSRAM,
		.end   = S3C_PA_SOCSRAM + S3C_SZ_SOCSRAM - 1,
		.flags = IORESOURCE_MEM,
	},
};

struct platform_device s3c_device_socsram = {
	.name		  = "s3c-socsram",
	.id		  = -1,
	.num_resources	  = ARRAY_SIZE(s3c_socsram_resource),
	.resource	  = s3c_socsram_resource,
};
#endif
