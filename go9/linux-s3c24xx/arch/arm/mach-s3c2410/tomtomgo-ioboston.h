#define SUPPORT_BOSTON

static backlight_mapping_t boston_bl_mapping = {17,22,26,31,34,36,38,40,42,45,47,
...
inline void IO_InitBoston(void)
{
	VALUE_SET(id                 , GOTYPE_BOSTON);
	...
	VALUE_SET(backlight_mapping  , &boston_bl_mapping);
#ifdef __KERNEL__
