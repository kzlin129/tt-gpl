#define SUPPORT_CASABLANCA_SIRF
//#define SUPPORT_CASABLANCA_PR0
inline void IO_InitCasablancaSirf(void)
{
	VALUE_SET(id                 , GOTYPE_CASABLANCA);
	...
	STRING_SET(usbname,"ONE (v7)");
	STRING_SET(familyname,"TomTom ONE");
	STRING_SET(projectname,"Casablanca E");
...
#ifdef SUPPORT_CASABLANCA_PR0
	PIN_SET(DOCK_PWREN         , PIN_GPA18 | PIN_INVERTED);
#else
...
/* Casablanca Y1 and Y3 (Sirf) */
inline void IO_InitCasablancaSirfY1Y3( void )
{
}
