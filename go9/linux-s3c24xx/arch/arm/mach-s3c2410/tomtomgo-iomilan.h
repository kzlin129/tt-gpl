#define SUPPORT_MILAN
inline void IO_InitMilan(void)
{
	VALUE_SET(id                 , GOTYPE_MILAN);
...
void IO_InitMilanM2(void)
{
	STRING_SET(name,"TomTom GO 520");
	STRING_SET(btname,"TomTom GO 520");
	STRING_SET(usbname,"GO 520");
}

void IO_InitMilanM4(void)
{
	STRING_SET(name,"TomTom GO 520");
	STRING_SET(btname,"TomTom GO 520");
	STRING_SET(usbname,"GO 520");
...
void IO_InitMilanM6(void)
{
	STRING_SET(name,"TomTom GO 720");
	STRING_SET(btname,"TomTom GO 720");
	STRING_SET(usbname,"GO 720");
}

void IO_InitMilanM8(void)
{
	STRING_SET(name,"TomTom GO 920");
	STRING_SET(btname,"TomTom GO 920");
	STRING_SET(usbname,"GO 920");
