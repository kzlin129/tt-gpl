#define SUPPORT_FAYETTEVILLE_LIMERICK

inline void IO_InitFayettevilleLimerick(void)
{
	VALUE_SET(id                 , GOTYPE_FAYETTEVILLE_LIMERICK);
	...
	VALUE_SET(needsvcclcmforiddetect,1); // yes, still not fixed yet
//	VALUE_SET(gpstype            , GOGPS_GL);
	...
	STRING_SET(projectname,"Fayetteville L");
