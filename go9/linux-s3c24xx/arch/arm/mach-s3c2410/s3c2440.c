...
{
	s3c_pm_do_save(s3c2440_sleep, ARRAY_SIZE(s3c2440_sleep));
	return 0;
}

static int s3c2440_resume(struct sys_device *dev)
{
	s3c_pm_do_restore(s3c2440_sleep, ARRAY_SIZE(s3c2440_sleep));
	return 0;
}
...
void __init s3c2440_init_clocks(int xtal)
{
	...
	fclk = 2 * s3c2410_get_pll(__raw_readl(S3C2410_MPLLCON), xtal);
	...
	printk("S3C2440: core %lu.%03lu MHz, memory %lu.%03lu MHz, peripheral %lu.%03lu MHz\n",
