...
inline void IO_InitCork(void)
{
	VALUE_SET(id                 , GOTYPE_CORK);
	...
	STRING_SET(usbname,"ONE (v4)");
	STRING_SET(familyname,"TomTom ONE");
	STRING_SET(projectname,"CORK");
	STRING_SET(requiredbootloader,"4.86");
...
inline void IO_InitCorkZ1Z2( void )
{
        VALUE_SET( sdisharedbus   , 1 );
        VALUE_SET( internalflash  , 1 );
}

inline void IO_InitCorkZ3( void )
{
