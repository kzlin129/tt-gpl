#define SUPPORT_ACTON
static backlight_mapping_t ActonMapTable = {
	17, 23, 29, 34, 38, 42, 44, 47, 50, 53, 56, 59, 63, 66, 69, 72, 76, 80, 84, 87, 90 };

inline void IO_InitActon(void)
{
	VALUE_SET(id                 , GOTYPE_ACTON);
	...
	VALUE_SET(backlight_mapping  , &ActonMapTable);
