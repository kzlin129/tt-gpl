...
#if 0
	/* This next setting is critical to the OV6620. It seems to improve
	 * the gain or the contrast. The "reserved" bits seem to have some
	 * effect in this case. Does it have the same effect with the OV6630? */
