/* drivers/video/tomtom/lq043t3dw02.c
 *
 * Specific functionality for the Sharp LQ043T3DW02 screen. See:
...
void LQ043T3DW02_Init(void)
{
	add_lcdspecs.divider = (unsigned long int) get_clkval( &ttgfb_lq043t3dw02_lcdspecs,
								ttgfb_lq043t3dw02_lcdspecs.refresh_max,
								ttgfb_lq043t3dw02_lcdspecs.curr_hclk );

	get_hozlineval( &ttgfb_lq043t3dw02_lcdspecs, &add_lcdspecs.hozval, &add_lcdspecs.lineval );

  	delay_1us_more();
	ttgfb_lcd_controller->initialize( &ttgfb_lq043t3dw02_lcdspecs, &add_lcdspecs);
	delay_1us_more();

	IO_Activate(LCD_RESET); //SHUT: VCI->GND
	mdelay(300); // at least wait for 15 frames
}

void LQ043T3DW02_Off(void)
{
...
struct lcd_screen_info ttgfb_lq043t3dw02_lcdspecs = {"SHP", "LQ043T3DW02", 95, 54, 480, 272, 25, 62, LQ043T3DW02_Init, LQ043T3DW02_Off, NULL,
