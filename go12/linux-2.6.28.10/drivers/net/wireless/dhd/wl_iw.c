...
DECLARE_COMPLETION(wl_essid_complete);
...
)
{
	...
	INIT_COMPLETION(wl_essid_complete);
	if (!wait_for_completion_interruptible_timeout(&wl_essid_complete, HZ)) {
