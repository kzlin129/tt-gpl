/*
 * venice_adau1761.c  --  SoC audio for Venice with ADAU1761
 *
...
static int s3c64xx_socmst_hw_params(struct snd_pcm_substream *substream,
	struct snd_pcm_hw_params *params)
{
	 ...
	 * both the ADAU1761 codec as well as the S3C64XX AP
	 *
	...
	case SNDRV_PCM_FORMAT_S8:
		...
		rfs = adau1761_rfs;	/* Table 35.2 S3C64XX UM, 256, 384 or 768 */
		break;
	...
	case SNDRV_PCM_FORMAT_S24_LE:
		bfs = 32;			/* Table 35.2 S3C64XX UM */
		rfs = adau1761_rfs;	/* Table 10.01-2 S3C64XX UM, 256, 384 or 768 */
		break;
	default:
		return -EINVAL;
	}
...
static struct snd_soc_ops s3c64xx_hifi_ops = {
	.hw_params = s3c64xx_socmst_hw_params,
};
...
static const struct snd_kcontrol_new adau1761_s3c64xx_controls[] = {
 ...
 */
static int s3c64xx_adau1761_init(struct snd_soc_codec *codec)
{
	int i, err;
	...
	for (i = 0; i < ARRAY_SIZE(adau1761_s3c64xx_controls); i++) {
		err = snd_ctl_add(codec->card,
				snd_soc_cnew(&adau1761_s3c64xx_controls[i],
				codec, NULL));
		if (err < 0)
			return err;
	}
...
static struct adau1761_setup_data s3c64xx_adau1761_setup = {
	.i2c_bus = 0,
...
static struct snd_soc_device s3c64xx_snd_devdata = {
	...
	.codec_data = &s3c64xx_adau1761_setup,
};
...
MODULE_DESCRIPTION("ALSA SoC ADAU1761 for Venice");
MODULE_LICENSE("GPL");
