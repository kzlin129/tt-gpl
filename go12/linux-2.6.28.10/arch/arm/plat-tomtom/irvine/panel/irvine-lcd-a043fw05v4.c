...
#define LCM_MODEL_NAME  "A043FW05V4"
...
static void a043fw05v4_serial_write (unsigned short data)
{
	int i;
...
static void a043fw05v4_tx_data (unsigned char indx, unsigned char data)
{
	...
	gpio_set_value(TT_VGPIO_LCD_CS, 1);
        ...
        a043fw05v4_serial_write(value);
        gpio_set_value(TT_VGPIO_LCD_CS, 1);

        panel_sleep(1);
}

static void a043fw05v4_display_on(void)
{
	panel_sleep(5); /* Delay more than 2 ms */

        a043fw05v4_tx_data(5, 0x1E); /* Reset / Standby */
        a043fw05v4_tx_data(5, 0x5E); /* Reset / Standby */
        a043fw05v4_tx_data(5, 0x5F); /* Reset / Standby */
        a043fw05v4_tx_data(2, 0x1F); /* Contrast (default) */
        a043fw05v4_tx_data(3, 0x40); /* Brightness (default) */
        a043fw05v4_tx_data(6, 0x08); /* HBLK_EN / VBLK (default) */
        a043fw05v4_tx_data(7, 0x28); /* HBLK (default) */
        a043fw05v4_tx_data(8, 0x4);  /* DE mode */
        a043fw05v4_tx_data(12, 0 << 3 | 1 << 2 | 1 << 1 | 1 << 0);
...
static void a043fw05v4_display_off(void)
{
	u32 val;
...
static void a043fw05v4_enable (struct clk *clk)
{
	a043fw05v4_display_on();
}

static void a043fw05v4_disable (struct clk *clk)
{
}

static void a043fw05v4_suspend (struct clk *clk)
{
        a043fw05v4_display_off();
}

static void a043fw05v4_resume (struct clk *clk)
{
}

static void a043fw05v4_init (struct clk *clk)
{
        a043fw05v4_display_on();
}

static void a043fw05v4_setup (struct clk *clk)
{
	printk ("Panel: %s\n", LCM_MODEL_NAME);
...
static struct clcd_panel_cntrl cntrl = {
	.enable		= a043fw05v4_enable,
	.disable	= a043fw05v4_disable,
	.suspend	= a043fw05v4_suspend,
	.resume		= a043fw05v4_resume,
	.init		= a043fw05v4_init,
	.setup		= a043fw05v4_setup,
};
...
static struct clcd_device a043fw05v4 = {
	.timings = &timings,
	.cntrl 	 = &cntrl,
};

struct clcd_paneldev A043FW05V4_WithPLL =
{
	.panel 		= &a043fw05v4,
	.lcd_mdiv	= 0x00000018,
};
