...
static void lms500hf10_enable (struct clk *clk)
{
	gpio_set_value(TT_VGPIO_LCD_ON, 1);
}

static void lms500hf10_disable (struct clk *clk)
{
	gpio_set_value(TT_VGPIO_LCD_ON, 0);	/* T5-T4 should be greater than 6 frames */
	panel_sleep(150);
}

static void lms500hf10_suspend (struct clk *clk)
{
	u32 val;
...
static void lms500hf10_resume (struct clk *clk)
{
...
static void lms500hf10_init (struct clk *clk)
{
	gpio_set_value(TT_VGPIO_LCD_ON, 0);	/* Initially LCD_OFF in the begining of T2 */
}

static void lms500hf10_setup (struct clk *clk)
{
	printk (KERN_INFO "Panel: LMS500HF10\n");
...
static struct clcd_panel_cntrl cntrl = {
	.enable		= lms500hf10_enable,
	.disable	= lms500hf10_disable,
	.resume		= lms500hf10_resume,
	.suspend	= lms500hf10_suspend,
	.init		= lms500hf10_init,
	.setup		= lms500hf10_setup,
};
...
static struct clcd_device lms500hf10 = {
	.timings = &timings,
	.cntrl   = &cntrl,
};

struct clcd_paneldev LMS500HF10_WithPLL =
{
	.panel 		= &lms500hf10,
	.lcd_mdiv	= 0x00000018,
};
