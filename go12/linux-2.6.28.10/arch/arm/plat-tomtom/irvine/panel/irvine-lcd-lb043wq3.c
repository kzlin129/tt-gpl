...
#define LCM_MODEL_NAME  "LB043WQ3"
...
static void lb043wq3_display_on(void)
{
        panel_sleep(20);
	gpio_set_value(TT_VGPIO_LCD_ON, 1);
}

static void lb043wq3_display_off(void)
{
	u32 val;
...
static void lb043wq3_enable (struct clk *clk)
{
	lb043wq3_display_on();
}

static void lb043wq3_disable (struct clk *clk)
{
}

static void lb043wq3_suspend (struct clk *clk)
{
        lb043wq3_display_off();
}

static void lb043wq3_resume (struct clk *clk)
{
}

static void lb043wq3_init (struct clk *clk)
{
        lb043wq3_display_on();
}

static void lb043wq3_setup (struct clk *clk)
{
	printk ("Panel: %s\n", LCM_MODEL_NAME);
...
static struct clcd_panel_cntrl cntrl = {
	.enable		= lb043wq3_enable,
	.disable	= lb043wq3_disable,
	.suspend	= lb043wq3_suspend,
	.resume		= lb043wq3_resume,
	.init		= lb043wq3_init,
	.setup		= lb043wq3_setup,
};
...
static struct clcd_device lb043wq3 = {
	.timings = &timings,
	.cntrl 	 = &cntrl,
};

struct clcd_paneldev LB043WQ3_WithPLL =
{
	.panel 		= &lb043wq3,
	.lcd_mdiv	= 0x00000018,
};
