...
#define S5PC1XX_GPE1_0_CAM_A_DATA_5	(0x2 << 0)
#define S5PC1XX_GPE1_0_GPIO_INT9_0	(0xf << 0)

#define S5PC1XX_GPE1_1_CAM_A_DATA_6	(0x2 << 4)
#define S5PC1XX_GPE1_1_GPIO_INT9_1	(0xf << 4)

#define S5PC1XX_GPE1_2_CAM_A_DATA_7	(0x2 << 8)
#define S5PC1XX_GPE1_2_GPIO_INT9_2	(0xf << 8)

#define S5PC1XX_GPE1_3_CAM_A_CLKOUT	(0x2 << 12)
#define S5PC1XX_GPE1_3_GPIO_INT9_3	(0xf << 12)

#define S5PC1XX_GPE1_4_CAM_A_FIELD	(0x2 << 16)
#define S5PC1XX_GPE1_4_GPIO_INT9_4	(0xf << 16)
#endif
