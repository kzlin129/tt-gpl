...
#define S3C_USBOTG_PHYTUNE		S3C_USBOTG_PHYREG(0x20)
...
#define DEBOUNCE_TINE				(0x1<<17)
#define CONNECTOR_ID_STATUS			(0x1<<16)
#define DEVICE_HNP_ENABLE			(0x1<<11)
#define HOST_SET_HNP_ENABLE			(0x1<<10)
#define HNP_REQUEST				(0x1<<9)
#define HOST_NEGOTIATION_SUCCESS		(0x1<<8)
#define SESSION_REQUEST				(0x1<<1)
#define SESSION_REQUEST_SUCCESS			(0x1<<0)

/* S3C_UDC_OTG_GOTGINT OTG interrupt register */
#define INT_DBNCE_DONE				(0x1<<19)
#define INT_ADEV_TOUT_CHNG			(0x1<<18)
#define INT_HST_NEG_DET				(0x1<<17)
#define INT_HST_NEG_SYC_STS_CHNG		(0x1<<9)
#define INT_SES_REQ_SUC_STS_CHNG		(0x1<<8)
#define INT_SES_END_DET				(0x1<<2)
