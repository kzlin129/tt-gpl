...
} BCM59040_CSR_State_t;

typedef struct
{
   BCM_PMU_Regulator_State_t ldo1;
   BCM_PMU_Regulator_State_t ldo2;
   BCM_PMU_Regulator_State_t ldo3;
   BCM_PMU_Regulator_State_t ldo4;
   BCM_PMU_Regulator_State_t ldo5;
   BCM_PMU_Regulator_State_t ldo6;
   BCM59040_CSR_State_t csr;
   BCM_PMU_Regulator_State_t iosr;
} bcm59040_PMx_map_t;

/* XXX too generic to be here, or should change name */
struct pmu_platform_map {
	bcm59040_regulator_map_t	*regulator_map;
	u32				*csr_nodvs_map;
	bcm59040_regulator_map_t	map_nodvs_config;
	u32				*csr_dvs_map;
	bcm59040_regulator_map_t	map_dvs_config;
	u32				*vsr_curr_limit_to_mA_map;
	u32				*charging_curr_to_mA_map;
	bcm59040_PMx_map_t		*PMx_map;
