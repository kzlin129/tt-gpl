...
#define	IPC_CP_MAX_CRASH_CODE           15
...
typedef struct IPC_PlatformSpecificUartLowPowerInfo_S
{
	IPCvoidReturnvoidFPtr_T				SemaphoreAccessDelayUartLP_FPtr_T;
	IPCvoidReturnvoidFPtr_T				EnableHWUartLowPowerFPtr_T;
	IPCvoidReturnvoidFPtr_T				DisableHWUartLowPowerFPtr_T;
	IPCPSCheckUartLowPowerAllowedFPtr_T	CheckUartLowPowerAllowedFPtr_T;
} IPC_PlatformSpecificUartLowPowerInfo_T;
...
typedef struct IPC_ControlInfo_S
{
	...
	IPC_PlatformSpecificUartLowPowerInfo_T * UartLowPowerStruct;
} IPC_ControlInfo_T;
...
typedef struct IPC_UartLowPowerInfo_S
{
	volatile IPC_Boolean				ApUartLowPowerAllowed;
	volatile IPC_Boolean				ApAccessSharedUartLowPowerDWORD;
	volatile IPC_SmCPUSleepState_T		ApUartLowPower_DUMMY;	//not used
	volatile IPC_Boolean				CpUartLowPowerAllowed;
	volatile IPC_Boolean				CpAccessSharedUartLowPowerDWORD;
	volatile IPC_SmCPUSleepState_T		CpUartLowPower_DUMMY;	//not used
} IPC_UartLowPowerInfo_T;
...
IPC_ReturnCode_T IPC_CpEnableUartLowPowerMode(IPC_Boolean bTx);
IPC_ReturnCode_T IPC_CpDisableUartLowPowerMode(IPC_Boolean bTx);
